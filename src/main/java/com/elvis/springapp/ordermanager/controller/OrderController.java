package com.elvis.springapp.ordermanager.controller;

import com.elvis.springapp.ordermanager.domain.Order;
import com.elvis.springapp.ordermanager.repository.OrderRepository;
import com.elvis.springapp.ordermanager.resource.OrderResource;
import com.elvis.springapp.ordermanager.resource.OrderResourceAssembler;
...
public class OrderController {
    ...
    public ResponseEntity<OrderResource> findOrderById(@PathVariable Long id){
        ...
        if(order.isPresent()){
            return new ResponseEntity<>(assembler.toResource(order.get()), HttpStatus.FOUND);
        }else{
    ...
    public ResponseEntity<Void> deleteOrder(@PathVariable Long id){
        ...
        HttpStatus response = wasDeleted ? HttpStatus.NO_CONTENT : HttpStatus.NOT_FOUND;
